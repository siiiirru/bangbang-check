...
interface CostSectionProps {
  data: {
    ...
    brokerageFee?: number
    utilityFee?: number
    maintenanceItems?: Record<string, boolean>
    utilityItems?: Record<string, boolean>
    mortgageBelow70Percent?: boolean
  }
  updateFormData: (data: any) => void
}

export function CostSection({ data, updateFormData }: CostSectionProps) {
  ...
  const handleUtilityItemChange = (item: string, checked: boolean) => {
    updateFormData({
      utilityItems: {
        ...(data.utilityItems || {}),
        [item]: checked,
          ...
          <div className="mt-2 grid grid-cols-2 gap-2">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleMaintenanceItemChange("internet", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleMaintenanceItemChange("tv", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleMaintenanceItemChange("gas", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleMaintenanceItemChange("electric", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleMaintenanceItemChange("water", checked as boolean)}
              />
          ...
          <div className="mt-2 grid grid-cols-2 gap-2">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleUtilityItemChange("gas", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleUtilityItemChange("electric", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleUtilityItemChange("water", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleUtilityItemChange("separateMeter", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleUtilityItemChange("individualHeating", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleUtilityItemChange("centralHeating", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleUtilityItemChange("districtHeating", checked as boolean)}
              />
