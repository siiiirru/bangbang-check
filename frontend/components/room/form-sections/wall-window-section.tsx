...
interface WallWindowSectionProps {
  data: Record<string, any>
  updateFormData: (data: any) => void
}

export function WallWindowSection({ data, updateFormData }: WallWindowSectionProps) {
  const handleChange = (key: string, value: any) => {
    updateFormData({ [key]: value })
  }

  const handleOutsideItemChange = (item: string, checked: boolean) => {
    updateFormData({
      outsideItems: {
        ...(data.outsideItems || {}),
        [item]: checked,
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleOutsideItemChange("wall", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleOutsideItemChange("bar", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleOutsideItemChange("restaurant", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleOutsideItemChange("recycling", checked as boolean)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleOutsideItemChange("other", checked as boolean)}
              />
