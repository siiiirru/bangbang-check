...
interface RankingListProps {
  ...
  isLoading: boolean
  allRooms: Room[]
  onUpdateRanking: (position: number, roomId: string) => void
}

export function RankingList({ rankings, isLoading, allRooms, onUpdateRanking }: RankingListProps) {
  ...
  useEffect(() => {
    ...
    setHasChanges(false)
  }, [rankings]) // sortedRankings 대신 rankings에 의존

  // 방 선택 핸들러
  const handleRoomSelect = (position: number, roomId: string) => {
